...
public class Pawn extends Piece {
    ...
    private boolean isPawnMove(final BasicMovement move, final Board board) {
    ...
    private boolean isOneSquareMove(final BasicMovement move) {
        return move.getTarget().getY() - move.getSource().getY() == getOrientation();
    }

    private boolean isTwoSquareMove(final BasicMovement move) {
    ...
    private boolean isCapture(final BasicMovement move, final Board board) {
